-- =====================================================
-- CONFIGURAR USUÁRIO ADMIN COM ESTRUTURA CORRIGIDA
-- =====================================================
...
-- 2. INSERIR PERFIL ADMIN COM ESTRUTURA CORRETA
...
SELECT 
    ...
    'Emerson Mota Ramos',
    email,
    '12345678', -- RG padrão (pode ser alterado depois)
    'admin',
    'approved',
    true,
    true,
...
SELECT 'PERFIL ADMIN CRIADO:' as info, user_id, full_name, email, rg, profile_type, approval_status, is_admin, is_active
...
-- 7. VERIFICAR COLUNAS DA TABELA PROFILES
SELECT 'COLUNAS PROFILES:' as info;
...
-- 1. Execute PRIMEIRO o script: corrigir-estrutura-banco.sql
-- 2. Execute ESTE script: setup-admin-corrigido.sql
...
-- ✅ Perfil admin criado em public.profiles com RG
-- ✅ Todas as permissões funcionando
-- ✅ Função has_permission retornando true para admin
-- ✅ Estrutura das tabelas correta (nome completo, email, RG)
...
-- Solução: Execute primeiro o script corrigir-estrutura-banco.sql
